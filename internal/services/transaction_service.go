...
type TransactionService interface {
	ProcessDeposit(req *models.TransactionRequest, claims *models.Claims) (string, error)
	ProcessWithdraw(req *models.TransactionRequest, claims *models.Claims) (string, error)
	ProcessTransfer(req *models.TransferRequest, claims *models.Claims) (string, error)
}
...
func (s *transactionService) ProcessDeposit(req *models.TransactionRequest, claims *models.Claims) (string, error) {
	if req.Amount <= 0 {
...
func (s *transactionService) ProcessWithdraw(req *models.TransactionRequest, claims *models.Claims) (string, error) {
	if req.Amount <= 0 {
...
func (s *transactionService) ProcessTransfer(req *models.TransferRequest, claims *models.Claims) (string, error) {
	if req.Amount <= 0 {
